...
public class LoadDatabase {
    ...
    CommandLineRunner initDatabase(BookRepository repository) {
        ...
        return args -> {
            ...
            log.info("Preloading " + repository.save(new Book("The Apothecary Diaries: Volume 1", "Natsu Hyuuga", 1, 1, 178, LocalDate.of(2020, 12, 8), BookStatus.AVAILABLE)));
            log.info("Preloading " + repository.save(new Book("Frieren: Beyond Journey's End", "Kanehito Yamada", 1, 1, 192, LocalDate.of(2021, 11, 9), BookStatus.AVAILABLE)));
        };
    }
}
